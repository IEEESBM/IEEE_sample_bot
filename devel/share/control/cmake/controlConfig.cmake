...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/raghav/IEEE_sample_bot/src/control)
  set(control_DEVEL_PREFIX /home/raghav/IEEE_sample_bot/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/raghav/IEEE_sample_bot/install)
...
if(NOT "/home/raghav/IEEE_sample_bot/devel/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/raghav/IEEE_sample_bot/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raghav/IEEE_sample_bot/src/control/${idir}'.  ${_report}")
    endif()
...
set(control_EXPORTED_TARGETS "control_generate_messages_cpp;control_generate_messages_eus;control_generate_messages_lisp;control_generate_messages_nodejs;control_generate_messages_py")
...
foreach(depend ${depends})
  ...
  list(APPEND control_EXPORTED_TARGETS ${${control_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "control-msg-extras.cmake")
