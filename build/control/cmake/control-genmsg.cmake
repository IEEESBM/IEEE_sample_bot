...
set(MSG_I_FLAGS "-Icontrol:/home/raghav/IEEE_sample_bot/src/control/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Icontrol:/home/raghav/IEEE_sample_bot/src/control/msg")
...
get_filename_component(_filename "/home/raghav/IEEE_sample_bot/src/control/msg/FourWheeler.msg" NAME_WE)
add_custom_target(_control_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "control" "/home/raghav/IEEE_sample_bot/src/control/msg/FourWheeler.msg" ""
)
...
_generate_msg_cpp(control
  "/home/raghav/IEEE_sample_bot/src/control/msg/FourWheeler.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(TARGET control_generate_messages_cpp)
  add_dependencies(control_generate_messages_cpp control_generate_messages_cpp)
endif()
...
if(TARGET control_generate_messages_eus)
  add_dependencies(control_generate_messages_eus control_generate_messages_eus)
endif()
...
if(TARGET control_generate_messages_lisp)
  add_dependencies(control_generate_messages_lisp control_generate_messages_lisp)
endif()
...
if(TARGET control_generate_messages_nodejs)
  add_dependencies(control_generate_messages_nodejs control_generate_messages_nodejs)
endif()
...
if(TARGET control_generate_messages_py)
  add_dependencies(control_generate_messages_py control_generate_messages_py)
endif()
